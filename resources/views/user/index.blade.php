                                    ...
                                    <div class="tabbable-line">
                                        ...
                                        <div class="tab-content" style="font-size:16px;">
                                            ...
                                            <div class="tab-pane" id="tools2">
                                                <ol>
                                                    <li> <a href="{{asset('clients/ShadowsocksR-4.7.0-win.7z')}}" target="_blank">点击此处</a>下载客户端并启动 </li>
                                            ...
                                            <div class="tab-pane" id="tools3">
                                                <ol>
                                                    ...
                                                    <li> 单击状态栏小飞机，找到服务器->订阅管理->添加，复制黏贴订阅地址 </li>
                                                    <li> 更新订阅设置即可 </li>
                                                    <li> 配置->选项设置->通用设置 根据端口自己设定代理端口 </li>
                                                    <li> 注意PYTHON要2系列的 玩LINUX的我就不废话了</li>
                                                </ol>
                                            </div>
